...
BOT_TOKEN = '6149921374:AAGNUiZHFJbzejXpxRiojG7_JGfZuUEQacM' # Токен бота
admin = [5220673113] # Вставить свой ID
chromedriver = 'storage/emulated/0/chromedriver' # Путь до драйвера хром
